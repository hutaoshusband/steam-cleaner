...
impl Sandbox for CleanerApp {
    ...
    fn title(&self) -> String {
        "Steam Cleaner and Spoofer".to_string()
    }
        ...
        match message {
            ...
            Message::Execute => {
                if self.state == State::Idle {
                    ...
                    self.log_messages = vec!["Processing...".to_string()];
...
impl CleanerApp {
    fn view_main_window(&self) -> Element<'_, Message> {
        ...
        let title_bar = Row::new()
            ...
            .push(text("Steam Cleaner and Spoofer").size(32).style(style::TITLE_COLOR))
            .push(Space::with_width(Length::Fill))
            .push(inspector_button)
            .push(Space::with_width(Length::Fixed(20.0)));
        
        let system_spoofing_box = container(column![
        ...
        let steam_cleaning_box = container(column![
            text("Steam Cleaning").size(20),
        ...
        let aggressive_cleaning_box = container(column![
            text("Aggressive Cleaning").size(20),
        ...
        let backup_button = button(text("Backup Steam Data").size(20))
            ...
            .style(iced::theme::Button::Custom(Box::new(style::SecondaryButtonStyle)));
        ...
        let disclaimer = container(
            Row::new()
                ...
                .align_items(iced::Alignment::Center)
                .push(text("⚠️").size(20))
                .push(text(disclaimer_text).size(14))
        )
        .padding(10)
        .style(iced::theme::Container::Custom(Box::new(style::WarningBoxStyle)));
        ...
        let content = Column::new()
            ...
            .push(system_spoofing_box)
            .push(Space::with_height(Length::Fixed(10.0)))
            .push(steam_cleaning_box)
            .push(Space::with_height(Length::Fixed(10.0)))
            .push(aggressive_cleaning_box)
            .push(Space::with_height(Length::Fixed(20.0)))
            ...
            .push(status_box)
            .push(Space::with_height(Length::Fixed(10.0)))
            .push(text("credits: github.com/hutaoshusband, MIT License").size(12))
            .spacing(20)
            .align_items(iced::Alignment::Center)
            .max_width(600);
